...
## Charts
- graph to show when people logged their workout (time - y and day - x) line graph? ✅ done

## UI / Visual
- Streak flame intensity — streak number gets visually more intense (color, glow) the higher it gets. Makes long streaks feel earned.
...
- Badge page where people are awarded badges based on achievements. Examples:
  - "First Blood" — first to finish on a given day
  - "Late Finisher" — completed after a certain time
  - Others TBD
